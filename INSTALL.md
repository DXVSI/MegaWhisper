...
The `MegaWhisper-2.2.1-x86_64.flatpak` file can be installed directly:

```fish
flatpak install -y --user ./MegaWhisper-2.2.1-x86_64.flatpak
```
...
./MegaWhisper-2.2.1-x86_64.AppImage --appimage-updateinformation
env QT_QPA_PLATFORM=offscreen APPIMAGE_EXTRACT_AND_RUN=1 ./MegaWhisper-2.2.1-x86_64.AppImage --smoke-test
...
```fish
./MegaWhisper-2.2.1-x86_64.AppImage --remove-desktop-integration
```

If FUSE is unavailable, use:

```fish
env APPIMAGE_EXTRACT_AND_RUN=1 ./MegaWhisper-2.2.1-x86_64.AppImage
```
...
Expected payload assets for v2.2.1:

- `MegaWhisper-2.2.1-x86_64.AppImage`
- `MegaWhisper-2.2.1-x86_64.AppImage.zsync`
- `MegaWhisper-2.2.1-x86_64.flatpak`
- `io.github.dxvsi.megawhisper.flatpakref`
- `io.github.dxvsi.megawhisper.flatpakrepo`
- `MegaWhisper-2.2.1-third-party-compliance.tar.zst`
- `MegaWhisper-2.2.1-recovery.tar.zst`
- `megawhisper-release-key.asc`

## Third-party compliance

`MegaWhisper-2.2.1-third-party-compliance.tar.zst` contains binary SBOMs, build provenance, notices, license inventories, and corresponding source required for bundled third-party components. It does not contain MegaWhisper application source code.
